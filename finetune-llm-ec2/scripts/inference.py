...
#     system_prompt = "You are a media bias analyst. Classify the source of the following news headline as either 'Fox News' or 'NBC News'. Analyze the tone, word choice, and framing to make your decision."
...
#         true_label = data['messages'][2]['content']
...
#         # We strip non-alphanumeric chars just to be safe (e.g. "Fox News." -> "Fox News")
#         predicted_label = raw_prediction.strip()
